...
void make_cigarettes(char *smoker)
{
    printf("%s : Making\n", smoker);
    return;
}

void smoke_cigarettes(char *smoker)
{
    printf("%s : Smoking\n", smoker);
    return;
}
...
void *smoker1_func(void *args)
{
    while (1) {
        ...
        sem_wait(&tobacco);
        sem_wait(&matches);
        printf("Smoker1 : Got tobacco and matchess\n");

        make_cigarettes("Smoker1");
        smoke_cigarettes("Smoker1");
        sem_post(&agent_sem);
    }
    return NULL;
}
...
void *smoker2_func(void *args)
{
    while (1) {
        ...
        make_cigarettes("Smoker2");
        smoke_cigarettes("Smoker2");
        sem_post(&agent_sem);
    }
    return NULL;
}
...
void *smoker3_func(void *args)
{
    while (1) {
        ...
        make_cigarettes("Smoker3");
        smoke_cigarettes("Smoker3");
        sem_post(&agent_sem);
    }
    return NULL;
}
